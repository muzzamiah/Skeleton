...
<body style="height: 669px">
    <form id="form1" runat="server">
        ...
        <p style="height: 425px; margin-top: 0px">
            ...
            <asp:Label ID="lblStaffRole" runat="server" style="z-index: 1; left: 12px; top: 313px; position: absolute" Text="Role" width="79px"></asp:Label>
            ...
            <asp:Label ID="lblStaffEmail" runat="server" style="z-index: 1; left: 12px; top: 400px; position: absolute" Text="Staff Email" width="79px"></asp:Label>
            ...
            <asp:TextBox ID="txtStaffRole" runat="server" style="z-index: 1; left: 150px; top: 311px; position: absolute"></asp:TextBox>
            ...
            <asp:TextBox ID="txtStaffEmail" runat="server" style="z-index: 1; left: 150px; top: 401px; position: absolute"></asp:TextBox>
